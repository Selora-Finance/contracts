...
1. Deploy the V2 contracts:

`npx hardhat run script/hardhat/DeployV2.ts --network tenderly`

The contracts that were deployed will be saved in `script/constants/output/V2Output.json`. 
