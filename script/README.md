## Deploy  v2
 ...
 v2 deployment is a multi-step process.  Unlike testing, we cannot impersonate governance to submit transactions and must wait on the necessary protocol actions to complete setup.  This README goes through the necessary instructions to deploy the  v2 upgrade.
...
1. Deploy  v2 Core
```
forge script script/DeployV2.s.sol:DeployV2 --broadcast --slow --rpc-url optimism --verify -vvvv
```
...
3. Deploy v2 gauges and v2 pools.  These gauges are built on  v2 using newly created v2 pools.
```
