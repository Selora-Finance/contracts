...
/// @title  V2 Factory Registry
/// @author Carter Carlson (@pegahcarter)
/// @notice  V2 Factory Registry to swap and create gauges
contract FactoryRegistry is IFactoryRegistry, Ownable {
    ...
    /// @dev  protocol will always have a usable poolFactory, votingRewardsFactory, and gaugeFactory.  The votingRewardsFactory
