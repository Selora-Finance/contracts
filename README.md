...
V2 contracts for  Finance, an AMM on Optimism inspired by Solidly.
...
| `Library.sol` | Provides router-related helpers, eg. for price-impact calculations |
...
For general information about security include audits, bug bounty and deployed contracts, go [here](https://.finance/security).

### Access Control
See `PERMISSIONS.md` for more detail.
### Bug Bounty
 has a live bug bounty hosted on ([Immunefi](https://immunefi.com/bounty/finance/)).
